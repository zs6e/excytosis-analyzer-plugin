...
public class SaveUtils {
	public static void saveSecretionList(	
		...
		String[] columnTitle = new String[] {
				...
				"Est. Radius (" + parameter.pixelUnit + ")", // 8
				"R Square for Est. radius", // 9
		...
		for (Secretion s : detected_secretions) {
			...
			osw.write(
					...
					String.valueOf(s.getFinSlice()) +sep+
					String.valueOf(s.peakTime) +sep+
					String.valueOf(s.getStartX()) +sep+
					String.valueOf(s.getStartY()) +sep+
					String.valueOf(s.getMaxDisplacement()* parameter.pixelSize) +sep+
					String.valueOf(s.getEstimatedPeakRadius2D() * parameter.pixelSize) +sep+
					...
					String.valueOf(s.getMin()) +sep+
					String.valueOf(s.getMax()-s.getMin())
					);
			osw.write("\r\n");
		}
		osw.flush();
	...
	public static void saveVesicleList(
			String[] columnTitle,
