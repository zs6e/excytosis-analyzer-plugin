...
public class Vesicle {
	...
	public double EstimateSize1D() {
		...
		return GaussianParametresHorizontal[3] + GaussianParametresVertical[3]; //Apparent radius * 2 ===> apparent FWHM
	}
	...
	public double EstimateSize2D() {
		//Apparent radius * 2 ===> apparent FWHM
		if (!this.isValid)
			return 0;
		if (Rsqr2D != 0) {
			return Gauss2DParam[4] * 2;
		} else {
			get2DGaussFitter();
			return Gauss2DParam[4] * 2;
		}
